...
//        //return result;
        ...
        map.put("name",loginCase.getUserName());
        map.put("password", loginCase.getPassword());

        HttpClient httpClient = HttpClients.createDefault();
        HttpPost postMethod = new HttpPost(TestConfig.loginUrl);//传入URL地址;
        ...
        try {
            ...
            res = httpClient.execute(postMethod);//获取响应
            int statusCode = res.getStatusLine().getStatusCode();
            System.out.println("HTTP Status Code:" + statusCode);

            String reponseContent = EntityUtils.toString(res.getEntity());
            EntityUtils.consume(res.getEntity());//释放资源
